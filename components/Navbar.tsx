        ...
        <div className='flex items-center justify-between h-14 sm:h-16'>
          ...
          <div className='flex items-center'>
            ...
            >
              ...
              <span className='text-sm sm:text-base md:text-lg lg:text-xl font-bold bg-gradient-to-r from-orange-500 via-amber-400 to-yellow-500 bg-clip-text text-transparent'>
