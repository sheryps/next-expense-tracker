...
const Footer = () => {
  return (
    <footer className='relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-emerald-900/20 border-t border-gray-100/50 dark:border-gray-700/50'>
      ...
      <div className='absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-orange-500 via-amber-400 to-yellow-500'></div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-8'>
          ...
          <div className='text-center md:text-left'>
            <div className='inline-flex items-center gap-2 mb-4'>
              <div className='w-7 h-7 sm:w-8 sm:h-8 md:w-10 md:h-10 bg-gradient-to-br rounded-lg sm:rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:rotate-3'>
                <img src="/favicon2.ico" alt="logo" className="w-full h-full object-contain rounded-lg"/>
              </div>
              <h2 className='text-xl font-bold bg-gradient-to-r from-orange-500 via-amber-400 to-yellow-500 bg-clip-text text-transparent'>
                ExpenseTracker AI
              </h2>
            </div>
          ...
          <div className='text-center md:text-left'>
            ...
            <div className='space-y-3'>
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-gradient-to-br from-orange-500 to-yellow-500
              ...
              <div className='flex items-center gap-3 text-gray-600 dark:text-gray-400 text-sm'>
                <div className='w-5 h-5 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-md flex items-center justify-center shadow-sm'>
                  <span className='text-white text-xs'>✨</span>
                </div>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='flex items-center gap-4'>
            <div className='inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 px-3 py-1 rounded-full text-xs font-medium'>
              <span className='w-1.5 h-1.5 bg-orange-500 dark:bg-orange-400 rounded-full animate-pulse'></span>
              Made by SG
            </div>
          </div>
        </div>
